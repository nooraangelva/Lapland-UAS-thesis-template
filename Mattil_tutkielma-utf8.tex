...
\newcommand{\aika}{{Kesäkuu 2021}}   %Kuukausi ja vuosi
\newcommand{\paaaine}{{Information and Communication Technology}} %tai Tilastotiede
...
\begin{center}
\includegraphics[width=10cm]{UAS_Logo} %talleta kuva linkistä omaan hakemistoosi
\end{center}
...
\vspace{0.5cm}
\begin{center}
%\tutkielma -tutkielma\\ poistettu autm. lisäys
\aika
\end{center}
